...
QT_MOC_LITERAL(1, 13, 22), // "controlButtonBeClicked"
QT_MOC_LITERAL(2, 36, 0) // ""

    },
    "ControlPanel\0controlButtonBeClicked\0"
    ""
};
...
void ControlPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->controlButtonBeClicked(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ControlPanel::controlButtonBeClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ControlPanel::controlButtonBeClicked()
{
